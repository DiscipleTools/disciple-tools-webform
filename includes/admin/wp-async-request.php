...
if ( !class_exists( 'DT_Webform_Async_Task' ) ) {
    /**
     * Class DT_Webform_Async_Task
     */
    abstract class DT_Webform_Async_Task
    {
        ...
        public function __construct( $auth_level = self::LOGGED_IN )
        {
            if ( empty( $this->action ) ) {
                return new WP_Error( 'missing_action', 'Action not defined for class ' . __CLASS__ );
            }
