...
if ( ! class_exists( 'Location_Grid_Meta' ) ) {
    class Location_Grid_Meta
    {
        ...
        public static function get_user_location_grid_meta( $grid_meta_id) {

        } // @todo

        public static function add_user_location_grid_meta( $user_id, $type, $value) {
        } // @todo

        public static function delete_user_location_grid_meta( $user_id, $type, $value) {
        } // @todo
