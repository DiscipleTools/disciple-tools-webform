...
class DT_Webform_Menu {
    ...
    public function register_menu() {
        ...
        add_submenu_page( 'dt_extensions', __( 'Webform', 'dt_webform' ), __( 'Webform', 'dt_webform' ), 'manage_dt', $this->token, [ $this, 'content' ] );
    }
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a href="<?php echo esc_attr( $link ) . 'second' ?>" class="nav-tab <?php ( $tab == 'second' ) ? esc_attr_e( 'nav-tab-active', 'dt_webform' ) : print ''; ?>"><?php esc_attr_e( 'Second', 'dt_webform' ) ?></a>
            </h2>
            ...
            switch ($tab) {
                case "general":
                    ...
                    break;
                case "second":
                    $object = new DT_Webform_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
